...
const BASELINE_TOKENS = new Set([
  // engineering / generic altitude
  'software', 'engineer', 'developer', 'manager', 'architect',
  'analyst', 'designer', 'consultant', 'specialist',
  'platform', 'systems', 'services',
  'backend', 'frontend', 'fullstack',
  // sales altitude / segment descriptors. Without these, two distinct
  // sales roles whose only overlap is the title altitude — e.g.
  // "Enterprise Account Executive, Industries" vs "...Tech" — score 0.75
  // and get wrongly deduped. The discriminating token is the vertical
  // (Industries/Tech/Healthcare), not the shared [enterprise, account,
  // executive] altitude. Mirrors the #633 fix for engineering roles.
  'account', 'executive', 'enterprise', 'strategic', 'commercial',
